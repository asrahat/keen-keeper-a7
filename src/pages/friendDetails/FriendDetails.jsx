    ...
    <div className="container mx-auto md:flex justify-between items-center gap-5 my-10">
      <div className="space-y-5">
        <div className="backdrop-blur-lg shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border flex flex-col justify-center items-center border-zinc-100 p-4 rounded-xl space-y-2">
          <img className="w-16 h-16  rounded-full" src={isFriendExist.picture} alt="" />
        ...
        <div className=" flex flex-col items-center space-y-3">
          <button className="btn w-full backdrop-blur-lg shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">Snooze 2 Week</button>
          <button className="btn w-full backdrop-blur-lg shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">Archive</button>
          <button className="btn w-full backdrop-blur-lg shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 text-red-500">Delete</button>
        </div>
      </div>
      ...
      <div className="space-y-5">
        <div className="grid md:grid-cols-3 gap-5">
          <div className="backdrop-blur-lg shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-zinc-100 px-12 py-6 text-center rounded-xl">
            <h2 className="text-2xl font-bold">{isFriendExist.days_since_contact}</h2>
            <p className="text-xl font-semibold text-zinc-500">Days Since Contact</p>
          </div>
          <div className="backdrop-blur-lg shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-zinc-100 px-12 py-6 text-center rounded-xl">
          ...
          <div className="backdrop-blur-lg shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-zinc-100 px-12 py-6 text-center rounded-xl">
            <h2 className="text-2xl font-bold">{isFriendExist.next_due_date}</h2>
        ...
        <div className="backdrop-blur-lg shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border flex justify-between items-center border-zinc-100 p-4 text-center rounded-xl">
          <div>
            ...
            <p className="text-xl font-semibold text-zinc-500">
              Connect every <span className="text-black font-bold">{isFriendExist.goal}</span>
            </p>
          </div>
